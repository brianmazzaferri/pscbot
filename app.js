...
app.shortcut('moderate_message', async ({ shortcut, ack, client }) => {
  ...
  try {
    ...
    if ((shortcut.user.id === "U013K053EPN") || (shortcut.user.id === "U012N53R2JZ") || (shortcut.user.id === "U015JA25BUL")|| (shortcut.user.id === "U01NPP1CFM4")||
...
app.view('atchannelmodal', async ({ ack, body, view, client, context }) => {
  ...
  // Message the user
  try {	  
	  const channelList = ['C02E2PV2CAF','C014Y67SJBS','C016LLGAXU2','C016RRG0E8Z','C013J925WPM','C013D739XCN','C01ARNG7FC2','C015T7WQF0X','C01N9FZQS1H','C013CQASWHY','C014RTLFMH7','C0144S7A24E','C013WM5EGNM','C01BF4MLA9H','C016GA6RQKW','C018DLSCYBY','C01M56UFT6J','C013QRNRJ1Z','C0139T2N3UP','C01EYD0G30E','C013J8GHT8B','C01L7MMDD0U','C019LM8AY9L','C013ULQKMPZ','C015M0YLCDQ','C014QDS30KT', 'C01A43H3E1M']
