...
If you are looking for best practices for this slack community, please review the <http://www.presalescollective.com/slack|PreSales Collective Slack Guidelines> page. In the #general channel, you will see that our channel directory is pinned to the group. Additionally, the Slackbot that messaged you when you joined is of help too! At PSC, we are obsessed with the first time user experience of this slack environment.\n\n
My only ask is that you are active! Answer questions, join the industry and help channels, and be an engaged member of the community. If you need a break, take it because we will still be here. The community can be slow or overwhelming depending on how often you use slack! Find the right channels for you and lean in. My best suggestion is to join the #virtual-coffee to meet others PreSales Professionals.\n\n
Welcome to PSC!\n\n
James Kaikis\n
